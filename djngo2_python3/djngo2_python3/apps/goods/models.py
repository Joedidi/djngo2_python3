...
class GoodsCategory(models.Model):
    ...
    # 设置models有一个指向自己的外键
    parent_category = models.ForeignKey("self", on_delete=models.CASCADE, null=True, blank=True, verbose_name="父类目级别", help_text="父类目", related_name="sub_cat")
...
class Goods(models.Model):
    ...
    goods_num = models.IntegerField("存库数", default=0)
